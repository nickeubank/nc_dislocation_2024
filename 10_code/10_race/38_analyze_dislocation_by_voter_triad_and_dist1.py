...
for name in map_names:
    ...
    map_limits = ((450_000, 920_000), (0, 325_000))
    ...
    dist_poly_w_scores.boundary.plot(ax=ax, edgecolor="black", linewidth=0.2)
    dist_poly_w_scores["district"] = (
        dist_poly_w_scores["district"].astype("str").str.strip()
    )
    # hand_adjustments = {
    #     "4": (0, 0),
    #     "5": (20_000, 0),
    ...
    ax.figure.text(0.01, 0.02, wrapped_note, horizontalalignment="left", fontsize=8)
...
for p in plots.keys():
    plots[p].figure.savefig(f"../../30_results/{p}triad_and_dist1.png")
